...
Execute unit tests
```
    cd "Alumniphase2.Lambda.VideoSplitter/test/Alumniphase2.Lambda.VideoSplitter.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "Alumniphase2.Lambda.VideoSplitter/src/Alumniphase2.Lambda.VideoSplitter"
